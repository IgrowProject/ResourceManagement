...
namespace IGrow.DataBase
{
    public class IGrowDbContext : DbContext
    {
        public IGrowDbContext()
            : base("IGrowDbContext")
        {
        ...
        {
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("IGrow.DataBase.DLL", "IGrow.Mapping.DLL").Replace("file:///", "");
