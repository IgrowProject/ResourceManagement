...
namespace IGrow.Web.Controllers
{
    ...
    public class ClientsDataController : Controller
    {
        ...
        private object GetDataItemList()
        {
            ...
            {
                var dataItemList = itemdata.FindAll(t => t.F_ItemId.Equals(item.IGrowID));
        ...
        private object GetOrganizeList()
        {
            ...
            foreach (OrganizeEntity item in data)
            {
                ...
                dictionary.Add(item.IGrowID, fieldItem);
            }
            return dictionary;
        }
        ...
        private string ToMenuJson(List<ModuleEntity> data, string parentId)
        {
            ...
            if (entitys.Count > 0)
            {
                foreach (var item in entitys)
                {
                    ...
                    strJson = strJson.Insert(strJson.Length - 1, ",\"ChildNodes\":" + ToMenuJson(data, item.IGrowID) + "");
